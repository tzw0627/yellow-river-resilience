...
- **三维降水演变**：覆盖 2000—2020 年逐日实测记录，历史期 11 个长期站、2020 年 19 个沿线站，蓝色雨柱随用户选择的年份和日期动态升降。
- **降水—FRI 联合研判**：按观测年份匹配 2000、2005、2010、2015、2020 年 FRI 风险快照，结合实测降水计算联合风险分、建议响应等级和重点核查任务。
...
仓库包含平台演示和运行所需的处理后数据，不包含原始大体量气象文件与中间遥感栅格。降水数据覆盖 2000—2020 年，时间分辨率以日尺度为主，适合历史过程复盘与辅助研判，不能代替实时气象预警。
